...
typealias ProductInfo = ( name: String, price: Double, currency: String, socet: String, processor: String)
...
let cart: [ProductInfo] = [
    ( "ASRock H310CV-HDV",  1717.0, "₴", "s1151",  "Intel"),
    ( "Asus Prime H310M-E R2.0",  2299.0,  "₴",  "s1151",  "Intel"),
    ( "Gigabyte H310M H",  1939.0,  "₴",  "s1151", "Intel"),
    ( "ASRock Q270 PRO BTC+",  4599.0,  "₴",  "s1151",  "Intel"),
    ("Biostar H310MHP",  1698.0,  "₴", "s1151", "Intel"),
    ( "MSI H30M Pro-VDN",  1649.0, "₴", "s1151",  "Intel"),
    ( "Asus WS C246 Pro", 10979.0,  "₴", "s1151", "Intel"),
    ( "Gigabyte B550 AORUS Elite",  5599.0,  "₴",  "sAM4",  "AMD"),
    ("Asus TUF Gaming B550-Plus", 5798.0,  "₴",  "sAM4",  "AMD"),
    ( "Asus TUF Gaming B550M-Plus",  4799.0,  "₴",  "sAM4", "AMD"),
    ( "Gigabyte B550M Aorus Elite",  4446.0,  "₴",  "sAM4",  "AMD"),
    ( "Asus TUF Gaming B550-Plus Wi-Fi II",  6599.0,  "₴", "sAM4",  "AMD"),
    ("Asus ROG Strix B550-A Gaming",  6999.0, "₴",  "sAM4",  "AMD"),
    ( "Asus ROG Strix B550-E Gaming",  8703.0,  "₴", "sAM4",  "AMD")
